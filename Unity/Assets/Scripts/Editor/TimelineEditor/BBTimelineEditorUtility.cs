...
namespace Timeline.Editor
{
    public static class BBTimelineEditorUtility
    {
        ...
        // private static Dictionary<string, object> ParamsTypeDict = new();
        // private static Dictionary<Type, Type> ParamsFieldDict = new();
        ...
        public static void RegistBBTrack()
        {
            ...
            var types = AssemblyHelper.GetAssemblyTypes(typeof (BBTimeline).Assembly);
